...
<body>
    ...
    <div class="text-center">
        <p class="text-center">Welcome admin {{ Auth::user()->name }}. Choose an option down below,please.</p><br>
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <a class="dropdown-item" href="{{url('/admin/ConsultAdultCats')}}">Consult cats</a>
